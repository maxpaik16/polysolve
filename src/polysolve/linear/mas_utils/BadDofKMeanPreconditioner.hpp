...
{
    class BadDofKMeanPreconditioner
    {
    public:
        bool empty() const
        {
        ...
        void set_kmeans_search_fraction(double search_fraction)
        {
            kmeans_search_fraction_ = search_fraction;
        }

        void set_kmeans_jump_threshold(double jump_threshold)
        {
            kmeans_jump_threshold_ = jump_threshold;
        }

        void set_kmeans_max_iterations(int max_iterations)
        {
            kmeans_max_iterations_ = max_iterations;
        }

        void set_kmeans_expand_neighbors(int expand_neighbors)
        {
            kmeans_expand_neighbors_ = (expand_neighbors > 0) ? expand_neighbors : 0;
        }
    ...
    private:
        ...
        double kmeans_search_fraction_ = 0.02;
        double kmeans_jump_threshold_ = 10.0;
        int kmeans_max_iterations_ = 32;
        int kmeans_expand_neighbors_ = 0;
